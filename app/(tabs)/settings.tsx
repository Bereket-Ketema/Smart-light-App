  ...
  const loadSavedUrl = async () => {
    try {
      ...
      if (savedUrl) {
        ...
        setBackendUrl("http://172.24.42.41:5000");
      }
    } catch (error) {
  ...
  const testBackendConnection = async () => {
    ...
    try {
      ...
      if (connected) {
        ...
        Alert.alert(
          "Failed",
          "Cannot connect to backend. Check the URL and make sure backend is running.",
        );
      }
    } catch (error) {
      setIsConnected(false);
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              style={styles.input}
              placeholder="http://172.24.42.41:5000"
            ...
            <Text style={styles.inputHint}>
              Example: http://172.24.42.41:5000 or http://localhost:5000
            </Text>
          </View>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            Make sure your Flask backend is running on the same network as your
            phone. Use ipconfig (Windows) or ifconfig (Mac/Linux) to find your
            computer IP address.
          </Text>
        </View>
      </KeyboardAvoidingView>
